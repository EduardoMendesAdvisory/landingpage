...
export function HeroLeadCalculator() {
  return (
    <div className="w-full max-w-[760px] flex flex-col items-center gap-4">
      ...
      <Link
        href="/assessment"
        className="w-full max-w-[640px] inline-flex items-center justify-center gap-2 bg-[#b67c2c] hover:bg-[#9f6c27] text-white text-sm font-bold uppercase tracking-wider py-3 rounded-lg transition-colors"
      >
        <Upload size={14} />
        Upload Your Quote
        <ArrowRight size={13} />
